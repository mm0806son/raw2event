"""
Export AEDAT4 data to CSV for sanity check.
"""
...
if recording.isEventStreamAvailable():
    ...
    events_pandas.to_csv(events_path, index=False)
...
if recording.isTriggerStreamAvailable():
    ...
    triggers_pandas.to_csv(triggers_path, index=False)
...
if recording.isImuStreamAvailable():
    ...
    imus_pandas.to_csv(imus_path, index=False)
